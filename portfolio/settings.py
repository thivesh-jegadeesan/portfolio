...
SECRET_KEY = "django-insecure-%hmt20zzb_kj0(5_gd*q@=#km5b(@i7^)vug3enkyqcxop^+k$"
...
STATIC_URL = "static/"
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'home', 'static'),  # Adjust this path based on your project structure.
],
